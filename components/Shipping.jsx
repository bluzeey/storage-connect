...
function Shipping() {
  return (
    <>
    <div className="bg-[url('/shippingBg.svg')] bg-cover rounded-br-[250px] flex justify-around items-center ">
    ...
    <div className="bg-[url('/Frame12.png')] bg-cover text-center text-white pb-36  -mt-52 rounded-tl-[250px]">
